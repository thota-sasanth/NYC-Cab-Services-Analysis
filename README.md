...
## Data Preprocessing
* _Handling Unnecessary & Missing data_: I cleaned the dataset by dropping unnecessary columns such as dispatching_base_num. I also dropped columns that had more than 60% of the data as NaN, duplicate rows, and rows with null values.
